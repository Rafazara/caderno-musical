...
export const FUNDAMENTALS: Fundamental[] = [
  {slug:"campo-harmonico",title:"O que é campo harmônico",subject:"Harmonia",summary:"As tríades que surgem ao empilhar terças sobre os graus de uma escala.",definition:"Campo harmônico é o conjunto de acordes derivados das notas de uma tonalidade.",body:["Em uma escala maior, escolhemos cada grau como fundamental e empilhamos terças diatônicas: uma nota, pulamos outra, escolhemos a próxima, e repetimos.","As qualidades resultam dos intervalos reais: I, IV e V maiores; ii, iii e vi menores; vii° diminuto.","Cifra nomeia um acorde. Numeral romano indica sua posição na tonalidade. Funções tonais descrevem comportamentos contextuais como centro, preparação e direção."],visual:null,related:["acordes","escala-maior","intervalo"],practice:{href:"/campo-harmonico",label:"Explorar o campo harmônico"}},
  {slug:"acordes",title:"O que são acordes e tríades",subject:"Acordes",summary:"Três notas construídas por relações intervalares.",definition:"Uma tríade é uma estrutura de três notas organizadas em terças: fundamental, terça e quinta.",body:["A fundamental dá nome ao acorde. A terça ajuda a determinar se a tríade é maior ou menor. A quinta, nas tríades maior e menor básicas, fica uma quinta justa acima da fundamental.","Dó maior é Dó–Mi–Sol porque Dó–Mi forma uma terça maior e Dó–Sol, uma quinta justa. Dó menor troca Mi por Mi♭, formando uma terça menor.","Dentro de um acorde, fundamental, terça e quinta são papéis harmônicos. Grau da escala é outra perspectiva: a posição de uma nota dentro de uma escala."],visual:null,related:["intervalo","escala-maior"],practice:{href:"/acordes",label:"Construir e ouvir tríades"}},
  {slug:'pulsacao',title:'O que é pulsação',subject:'Ritmo',summary:'A referência regular que organiza o tempo musical.',definition:'Pulsação é uma repetição regular que funciona como referência temporal da música.',body:['A pulsação é como um passo constante. O ritmo distribui sons e silêncios em relação a esse passo.','BPM indica quantas pulsações acontecem por minuto.'],visual:null,related:['figuras-musicais','compasso'],practice:{href:'/ritmo',label:'Sentir a pulsação'}},
  {slug:'figuras-musicais',title:'O que são figuras musicais',subject:'Ritmo',summary:'Símbolos que representam durações relativas.',definition:'Figuras musicais representam quanto tempo um som ou silêncio ocupa no contexto musical.',body:['Em 4/4, com a semínima como pulsação: semibreve ocupa quatro tempos, mínima dois, semínima um e colcheia meio.','Pausas possuem as mesmas durações: o silêncio também ocupa tempo.'],visual:'note-values',related:['pulsacao','compasso'],practice:{href:'/ritmo',label:'Explorar figuras'}},
  {slug:'compasso',title:'O que é compasso',subject:'Ritmo',summary:'A organização das pulsações em grupos.',definition:'Compasso organiza pulsações em grupos separados por barras de compasso.',body:['Em 4/4 há quatro pulsações principais e a semínima é a unidade de referência.','Um compasso pode ser preenchido por qualquer combinação de durações equivalentes à sua capacidade.'],visual:null,related:['pulsacao','figuras-musicais'],practice:{href:'/ritmo',label:'Praticar compassos'}},
  { slug:"intervalo",title:"O que é intervalo",subject:"Intervalos",summary:"A relação entre duas alturas, contada pelas letras e medida em semitons.",definition:"Intervalo musical é a distância entre duas notas; seu número vem das letras e sua qualidade, da distância cromática.",body:["Contamos também a nota inicial: Dó–Mi inclui Dó, Ré e Mi, portanto é uma terça.","Depois medimos a distância real. Dó–Mi possui quatro semitons e forma uma terça maior; Dó–Mi♭ possui três e forma uma terça menor.","Intervalos melódicos soam sucessivamente. Intervalos harmônicos soam simultaneamente."],visual:null,related:["tom-semitom","escala"],practice:{href:"/intervalos",label:"Explorar e praticar intervalos"} },
  {
    slug: "partitura",
